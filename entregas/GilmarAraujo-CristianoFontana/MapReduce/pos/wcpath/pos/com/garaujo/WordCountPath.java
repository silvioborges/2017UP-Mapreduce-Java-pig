...
public class WordCountPath extends Configured implements Tool {
		...
		public int run(String[] args) throws Exception {
			...
			job.setMapperClass(MapperPath.class);
		    job.setCombinerClass(ReducerPath.class);
			job.setReducerClass(ReducerPath.class);
		...
		public static void main(String[] args) throws Exception {
			WordCountPath driver = new WordCountPath();
