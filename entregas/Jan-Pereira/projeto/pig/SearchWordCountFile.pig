--ex: pig -f SearchWordCountFile.pig -param keyword=child -param input=fullbooks -param output=fullbooks/output/search
...
word_count = FOREACH word_groups GENERATE group, COUNT(filtered_words);

STORE word_count INTO '$output/$keyword';
